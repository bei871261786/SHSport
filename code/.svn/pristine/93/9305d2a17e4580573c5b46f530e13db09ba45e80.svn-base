 ...
 */
public class DingDanSfListViewAdapter extends DingdanBaseAdapter {
    ...
    public DingDanSfListViewAdapter(Context context, List<MatchsBean> mDatas, Handler handler, boolean isDanguan) {
        super(context);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        Holder holder = null;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.basketball_base_dingdanitem_3, null);
            holder = new Holder();
