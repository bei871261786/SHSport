...
public class NeweTagsProtocol extends BaseProtocol {
    public NeweTagsProtocol(Context context) {
        super(context);
    }
    ...
    protected String getDetailUrl() {
        return UrlManager.getNewsTags;
    }

    @Override
    protected Object parseData(String json) {
        Gson gson=new Gson();
        NewsTagsBean bean=gson.fromJson(json,NewsTagsBean.class);
        return bean;
    }
