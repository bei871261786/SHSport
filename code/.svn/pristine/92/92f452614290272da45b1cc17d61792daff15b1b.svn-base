...
public class CalcuNumGridViewAdapter extends BaseAdapter {
    ...
    public CalcuNumGridViewAdapter(List<String> mMissList, Context context) {
        this.mMissList = mMissList;
        this.context = context;
        init(mType);
    }

    public CalcuNumGridViewAdapter(List<String> mMissList, Context context, int mType) {
        this.mMissList = mMissList;
        this.context = context;
        this.mType = mType;
        init(mType);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            if (mType == 0) {
                view = View.inflate(context, R.layout.calculatenumber_item, null);
            } else {
                view = View.inflate(context, R.layout.calculate_numbg_item, null);
            }
