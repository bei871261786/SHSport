 ...
 */
public class ListviewRefreshLayout extends SwipeRefreshLayout implements AbsListView.OnScrollListener {
    ...
    public ListviewRefreshLayout(Context context, AttributeSet attrs) {
        ...
        mListViewFooter = LayoutInflater.from(context).inflate(R.layout.item_jifen, null, false);
    }
