 ...
 */
public class DingDanMixListViewAdapter extends DingdanBaseAdapter {
    ...
    public DingDanMixListViewAdapter(Context context, List<HashMap<Integer, MatchsBean>> mDatas, Handler handler, int mType) {
        super(context);
