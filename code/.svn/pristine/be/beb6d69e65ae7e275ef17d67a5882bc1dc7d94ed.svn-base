...
// * 作    者：yongchao.bei
// * 版    本：1.0
// * 创建日期：2016/12/5 16:34
// * 描    述：自定义视屏控制器
// * 修订历史：
// * ************************************************
// */
//
//public class CustomMediaController extends MyMediaController {
...
//    public CustomMediaController(Context context, VideoView videoView, Activity activity, boolean fromXml, View container) {
//        super(context, fromXml, container);
//        LogUtils.i("customController init:" );
...
//        mOperationTv.setVisibility(View.GONE);
//        LogUtils.i("customController context:" + context);
