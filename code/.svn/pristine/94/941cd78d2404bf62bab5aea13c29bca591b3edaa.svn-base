...
public class TitleGdvAdapter extends BaseAdapter {
    ...
    public TitleGdvAdapter(Context context, boolean isDan) {
    ...
    private void initData() {
        if (isDan) {
            mNames = context.getResources().getStringArray(R.array.syx5dan_title);
        } else {
            mNames = context.getResources().getStringArray(R.array.syx5_title);
        }
    }
