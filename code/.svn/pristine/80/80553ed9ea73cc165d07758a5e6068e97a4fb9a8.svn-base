...
import shlottery.gov.cn.lotterycenter.ui.jincailottery.soccer.adapter.ZongJinQiuExpandableListviewAdapter;
 ...
 */
public class ZongJinQiuFragment extends JcBaseFragment {

    @Override
    public View getView() {
        View view = UIUtils.inflate(R.layout.football_zongjinqiu_fragment);
        return view;
    }
