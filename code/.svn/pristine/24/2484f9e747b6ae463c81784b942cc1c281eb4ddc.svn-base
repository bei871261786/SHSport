 ...
 *
 /**
        ...
        * 作    者：booob
        * 版    本：1.0
        * 创建日期：2016-10-11-0011 13:39
        * 描    述：禁止了viewpager的预加载 地址:https://github.com/liu-hailin/LazyViewPager   其实也就是将viewpager源码中的DEFAULT_OFFSCREEN_PAGES 1改为0
        * 修订历史：
        * ================================================
        */
public class LazyViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
        ...
        /**
         * This method will be invoked when a new_sign page becomes selected.
         * Animation is not necessarily complete.
         *
         * @param position Position index of the new_sign selected page.
         */
         ...
         *
         * @param state The new_sign scroll state.
     ...
     *
     * @param item         Item index to select
     * @param smoothScroll True to smoothly scroll to the new_sign item, false to transition
     *                     immediately
     */
    ...
    void populate() {
        ...
        // fling to a new_sign position until we have finished the scroll to
        ...
        // Add any new_sign pages we need at the end.
    ...
    private void onSecondaryPointerUp(MotionEvent ev) {
        ...
        if (pointerId == mActivePointerId) {
            // This was our active pointer going up. Choose a new_sign
     ...
     *
     * @param v      View to IssueBonusJLDetailBean for horizontal scrollability
