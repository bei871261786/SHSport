...
import shlottery.gov.cn.lotterycenter.ui.adapter.RouteLineAdapter;
import shlottery.gov.cn.lotterycenter.utils.map.BikingRouteOverlay;
import shlottery.gov.cn.lotterycenter.utils.map.DrivingRouteOverlay;
import shlottery.gov.cn.lotterycenter.utils.map.MassTransitRouteOverlay;
import shlottery.gov.cn.lotterycenter.utils.map.OverlayManager;
import shlottery.gov.cn.lotterycenter.utils.map.TransitRouteOverlay;
...
public class RoutePlanActivity extends Activity implements BaiduMap.OnMapClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化地图
        stNode= (PlanNode) getIntent().getExtras().get("stNode");
        enNode= (PlanNode) getIntent().getExtras().get("enNode");
        ...
        backLl= (LinearLayout) findViewById(R.id.titlebar_back_ll);
