...
public class BqcDingdanAdapter extends BaseAdapter {
    private Context mContext;
    private SfcDingdanBean mSfcDingdanBean;

    public BqcDingdanAdapter(Context mContext, SfcDingdanBean mSfcDingdanBean) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.bqc_dingdan_item, null);
