...
public class PL3Zu3Fragment extends BaseFragment {
    ...
    @SuppressLint("ValidFragment")
    public PL3Zu3Fragment(ShakeUtils mShakeUtils,List<NumLotOrderBean> mNumLotOrderBeans) {
    ...
    protected View createLoadedView() {
        ...
        baselotteryTotalTv.setText("请选择投注号码");
        pl3GuizeTv.setText("至少选择2个号码");
        TextUtils.setStrColor(pl3JiangjinTv,"猜对开奖号(顺序不限)即中346元",346+"", BaseApplication.getApplication().getResources().getColor(R.color.select_red));
