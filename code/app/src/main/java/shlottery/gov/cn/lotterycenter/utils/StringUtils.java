...
public class StringUtils {
	...
	public static String splitString(String s, String split, int i) {
	...
	/**
	 * @param s    传入竞彩序号
	 * @param flag true 代表返回带序号如: 星期三01;false 表示不带序号  星期三
	 * @return
	 */
	public static String getWeek(String s, boolean flag) {
