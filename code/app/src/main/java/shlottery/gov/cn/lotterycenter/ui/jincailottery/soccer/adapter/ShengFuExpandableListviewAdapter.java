 ...
 */
public class ShengFuExpandableListviewAdapter extends BaseExpandableListAdapter {
    ...
    public ShengFuExpandableListviewAdapter(List<List<MatchsBean>> mDatas, Handler handler, Context mActivity) {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertViews, ViewGroup parent) {
        ...
        if (convertViews == null) {
            convertViews = mInflater.inflate(R.layout.sf_match_expandablelistview_child_item, null);
...
//                                mDatas.get(i).get(j).setSpsLostChecked(false);
        ...
        childHolder.bqc_analysis_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mActivity, BasketBallShujufenxiActivity.class);
