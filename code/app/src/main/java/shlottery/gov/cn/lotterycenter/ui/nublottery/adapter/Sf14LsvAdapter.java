...
public class Sf14LsvAdapter extends BaseAdapter {
    ...
    public Sf14LsvAdapter(List<Sf14Bean.DataBean.IssueListBean.MatchListBean> mSf14Beans, Context context, Handler mHandler, int ActivityType) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.sf14lsv_item, null);
        ...
        if (mSf14Beans.get(position).getWinRate() != null && mSf14Beans.get(position).getWinRate().size() > 0) {
            mViewHolder.sf14winTv.setText(mSf14Beans.get(position).getWinRate().get(0) + "%");
            mViewHolder.sf14pingTv.setText(mSf14Beans.get(position).getWinRate().get(1) + "%");
            mViewHolder.sf14fuTv.setText(mSf14Beans.get(position).getWinRate().get(2) + "%");
        } else {
            mViewHolder.sf14winTv.setVisibility(View.INVISIBLE);
            mViewHolder.sf14pingTv.setVisibility(View.INVISIBLE);
            mViewHolder.sf14fuTv.setVisibility(View.INVISIBLE);
        }
...
//        changeDan(position, mViewHolder.sfcdanTv);
    ...
    static class ViewHolder {
        ...
        @BindView(R.id.sfbase_gailv_tv)
        TextView sfbaseGailvTv;
