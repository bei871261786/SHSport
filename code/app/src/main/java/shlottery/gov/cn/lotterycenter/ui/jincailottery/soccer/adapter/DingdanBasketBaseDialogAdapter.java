 ...
 */
public class DingdanBasketBaseDialogAdapter extends DingdanBaseAdapter {
    ...
    public DingdanBasketBaseDialogAdapter(Context context, List<MatchsBean> mDatas, Handler handler, int mType, int mSubType, boolean isDanguan) {
        super(context);
