...
public class CalSf14Fragment extends CalculateBaseFragment {
    ...
    public void updateUi(CalculateEventBus messageEvent) {
        ...
        if (issueBonusSoccerDetailBean != null) {
            if (issueBonusSoccerDetailBean.getData().getLotId().equals("sfc")) {
                ...
                sf14CalculateLsvAdapter = new Sf14CalculateLsvAdapter(MatchListBeans, getActivity(), mHandler, Configs.ACTIVITYTYPE_SF14);
