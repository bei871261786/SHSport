...
public class IBDetaiBqcMatchAdapter extends BaseAdapter {

    private Context context;
    private List<IssueBonusSoccerDetailBean.DataBean.MatchListBean> mDatas;


    public IBDetaiBqcMatchAdapter(Context context, ArrayList<IssueBonusSoccerDetailBean.DataBean.MatchListBean> mDatas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Holder holder = null;
        if (null == convertView) {
            convertView = UIUtils.inflate(R.layout.adapter_ib_soccerresult_bqc);
            holder = new Holder();
        ...
        String qcGoal = bean.getHostGoal() + "-" + bean.getVisitGoal();
        String bcGoal = "(" + bean.getHostHalfGoal() + "-" + bean.getVisitHalfGoal() + ")";
        Resources resources = BaseApplication.getApplication().getResources();
        holder.goal.setText(qcGoal + bcGoal+"");
