 ...
 */
public class DingDanXsfListViewAdapter extends DingdanBaseAdapter {
    ...
    public DingDanXsfListViewAdapter(Context context, List<MatchsBean> mDatas, Handler handler, boolean isDanguan) {
        super(context);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        Holder holder = null;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.basketball_base_dingdanitem_xsf, null);
            holder = new Holder();
        ...
        if (hand > 0) {
            holder.match_ping_name.setTextColor(context.getResources().getColor(R.color.select_red));
        } else {
            holder.match_ping_name.setTextColor(context.getResources().getColor(R.color.standard_textcolor_c9));
        }
