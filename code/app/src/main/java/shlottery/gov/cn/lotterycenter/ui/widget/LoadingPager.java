...
import shlottery.gov.cn.lotterycenter.ui.manager.ThreadManager;
...
public abstract class LoadingPager extends FrameLayout {
    ...
    public LoadingPager(Context context, AttributeSet attrs, int defStyleAttr, boolean mLoadAnyhow) {
