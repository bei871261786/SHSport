...
public class JincaiBasketballProtocol extends BaseProtocol<JingCaiZuqiuInfo.DataBean> {
    private String mSubId = "";

    public JincaiBasketballProtocol(Context context) {
        super(context);
    }
