...
public final class RegexUtils {
   ...
   /* public static boolean checkNickname(String nickname) {
    ...
    //校验真实姓名
    public static boolean checkRealName(String nickName) {
    ...
    public static boolean checkPassWord(String passWord) {
        //        String regex = "(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,18}";/*(?!^\d+$)(?!^[a-zA-Z]+$)
        // [0-9a-zA-Z]{4,23}*/
        //        String regex = "[0-9a-zA-Z]{6,16}$";//6-16位数字字母组成 区分大小写
        String regex = "^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,16}$";//6-16位数字字母组成 区分大小写
    ...
    public static boolean checkSmsCode(String smsCode) {
        ...
        return Pattern.matches(regex, smsCode);
    }
