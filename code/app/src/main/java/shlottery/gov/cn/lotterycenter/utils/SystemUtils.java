...
//        return uniqueId;
    ...
    private static String getUUID() {
        String uuid = PrefUtils.getString(BaseApplication.getApplication(), "UUID", "");
        if (TextUtils.isEmpty(uuid)) {
            uuid = UUID.randomUUID().toString();
            PrefUtils.setString(BaseApplication.getApplication(), "UUID", uuid);
        }
        return uuid;
    }
