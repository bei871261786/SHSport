...
public class Bqc6LsvAdapter extends BaseAdapter {
    ...
    public Bqc6LsvAdapter(List<Sf14Bean.DataBean.IssueListBean.MatchListBean> mSf14Beans, Context context, Handler mHandler, int ActivityType) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.sfc_bqclsv_item, null);
        ...
        if (ActivityType == Configs.ACTIVITYTYPE_BQC) {
